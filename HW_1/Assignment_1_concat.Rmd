...
In this step, we decided to go for the model with the highest r-squared to test against. In this case the model `step_back` has R-squared value of 0.4. We applied the predict method to predict number of wins then round the output for readability. Finally, we record the generated predictions on disk.
