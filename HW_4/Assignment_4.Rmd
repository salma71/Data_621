...
We compute McFadden's pseudo R squared for logistic regression and we see that the difference between the full model and the reduced model is only marginal. We proceed with the smaller model with hopes of reducing variances at the expense of introducing a bit a bias.
...
We diagnose the reduced model for irregularities and violations of assumptions.
...
Only one outlier is identified. Consider removing?
...
### Model 3A: Penalized Logistic Model
