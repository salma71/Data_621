...
pred_train <- data.frame(TARGET=data_train_imputed$TARGET, 
                         model2=predict(model2, data_train_imputed, type="response"), 
                         model3=predict(model3, data_train_imputed, type="response"), 
                         model3b=predict(model3b, data_train_imputed, type="response"))
